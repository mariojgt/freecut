...
export const SCENE_VERIFICATION_MODEL_CACHE_MATCH_FRAGMENTS: Record<
  ...
  readonly string[]
> = {
  gemma: ['/onnx-community/gemma-4-e2b-it-onnx/', '/onnx-community/gemma-4-e4b-it-onnx/'],
...
export const SCENE_VERIFICATION_MODEL_CACHE_DESCRIPTIONS: Record<SceneVerificationModelId, string> =
  {
    gemma: 'Gemma assistant and scene-detection ONNX model files and processor assets.',
